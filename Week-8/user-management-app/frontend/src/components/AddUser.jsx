...
function AddUser() {
  ...
  return (
    <div>
       ...
       <input className='border-2 p-2 m-2' type="text" {...register("username", {required: true})} placeholder="Username"></input>
        <input className='border-2 p-2 m-2' type="email" {...register("email", {required: true})} placeholder="email"></input>
         <input className='border-2 p-2 m-2' type="date" {...register("dob", {required: true})} placeholder="dob"></input>
          <input className='border-2 p-2 m-2' type="number" {...register("phone", {required: true})} placeholder="Phone"></input>
